...
//   const currentUser = useProductStore((state) => state.currentUser); // Example: adjust based on your state management
//   const isOwner = currentUser?.id === entry.ownerId; // Check if the current user is the owner
